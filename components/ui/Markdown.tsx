...
// Render de markdown compartido por el bloque RichText y el blog público.
//
...
// Si algún día alguien añade rehype-raw aquí, abre un XSS en TODOS los tenants.

const external = (href?: string) => /^https?:\/\//i.test(href ?? '')

// Mapeo a nuestro sistema (no `prose`): coherente con el resto de bloques y
// brand-adaptive. Los encabezados bajan un nivel — la h1 ya la pone la página
// (el Hero en una página del builder, el título en un post del blog).
