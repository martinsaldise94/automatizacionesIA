...
- **Rama activa:** `feat/f4p8-campo-imagen` (Fase 4 Paso 8 cerrado: campo de imagen en Puck + arreglo del Hero + **variante nueva "imagen de fondo a pantalla completa"**, **386 tests** verde, sin commitear).
